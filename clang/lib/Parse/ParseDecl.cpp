...
void Parser::ParseWidbergSpoils(ParsedAttributes &Attrs,
    ...
    while (Tok.is(tok::kw___spoils)) {
      ...
      Attrs.addNew(KWName, KWLoc, nullptr, KWLoc, RegisterNames.data(), RegisterNames.size(), tok::kw___spoils);
...
void Parser::ParseWidbergShifted(ParsedAttributes &Attrs,
  ...
  Attrs.addNewShifted(KWName, KWLoc, nullptr, KWLoc, ParentName.get(), DeltaExpr.get(), tok::kw___shifted);
}
